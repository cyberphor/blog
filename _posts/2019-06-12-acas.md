---
layout: post
title: 'ACAS: Assured Compliance Assessment Solution 5.3'
permalink: 'acas'
category: notes
---
...
Configuring 3 DHCP NICs in CentOS 6.9
```
...
[VirtualBox] Install kernel headers in CentOS 6.9 
```
...
[VirtualBox] Add user to VirtualBox group to access shared folders
```
